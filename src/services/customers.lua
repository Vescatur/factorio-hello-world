...
local orders = {
    ...
    { band = 2, grade = 1, item = "inserter",               amount = 10,  refund = { penny = 28 },  profit = 1,
      spawn = { 25, 50, 25 } },
    { band = 2, grade = 2, item = "splitter",               amount = 10,  refund = { penny = 128 }, profit = 1,
      spawn = { 25, 25, 50 } },
    { band = 2, grade = 3, item = "assembling-machine-2",   amount = 5,   refund = { penny = 77, silver_coin = 5 }, profit = 1,
      spawn = { 25, 25, 25, up = 25 } },

    -- Banknote -- nothing here exists without coal and crude oil.
    { band = 3, grade = 1, item = "bulk-inserter",          amount = 5,   refund = { penny = 223, silver_coin = 15,  banknote = 1 }, profit = 1,
      spawn = { 25, 50, 25 } },
    { band = 3, grade = 2, item = "electric-furnace",       amount = 5,   refund = { penny = 223, silver_coin = 50,  banknote = 8 }, profit = 2,
      spawn = { 25, 25, 50 } },
    { band = 3, grade = 3, item = "productivity-module",    amount = 10,  refund = { penny = 238, silver_coin = 110, banknote = 5 }, profit = 1,
      spawn = { 25, 25, 25, up = 25 } },

    -- Bond -- the robot era.
    { band = 4, grade = 1, item = "construction-robot",     amount = 10,  refund = { penny = 182, silver_coin = 50,  banknote = 34 }, profit = 1,
      spawn = { 25, 50, 25 } },
    { band = 4, grade = 2, item = "logistic-robot",         amount = 10,  refund = { penny = 227, silver_coin = 90,  banknote = 36 }, profit = 1,
      spawn = { 25, 25, 50 } },
    { band = 4, grade = 3, item = "roboport",               amount = 2,   refund = { penny = 630, silver_coin = 180, banknote = 10 }, profit = 1,
      spawn = { 25, 25, 25, up = 25 } },
    ...
    { band = 5, grade = 1, item = "express-transport-belt", amount = 20,  refund = { penny = 315,  silver_coin = 20,  banknote = 4,  bond = 20 }, profit = 1,
      spawn = { 25, 50, 25 } },
    { band = 5, grade = 2, item = "beacon",                 amount = 5,   refund = { penny = 613,  silver_coin = 200, banknote = 9,  bond = 5 },  profit = 1,
      spawn = { 25, 25, 50 } },
    { band = 5, grade = 3, item = "productivity-module-3",  amount = 2,   refund = { penny = 2538, silver_coin = 665, banknote = 86, bond = 2 },  profit = 1,
      spawn = { 25, 25, 25, up = 25 } },
}
