...
**Prototype type string:** `type = "animation"`

Specifies an animation that can be used with [LuaRendering::draw_animation](../classes/LuaRendering.md#draw-animation) at runtime.
...
Name of the animation. Can be used with [LuaRendering::draw_animation](../classes/LuaRendering.md#draw-animation) at runtime.
