...
**Definition:** [float](../concepts/float.md) — Specifying a map gen dimension. ∣ `"none"` ∣ `"very-low"` ∣ `"very-small"` ∣ `"very-poor"` ∣ `"low"` ∣ `"small"` ∣ `"poor"` ∣ `"normal"` ∣ `"medium"` ∣ `"regular"` ∣ `"high"` ∣ `"big"` ∣ `"good"` ∣ `"very-high"` ∣ `"very-big"` ∣ `"very-good"`
