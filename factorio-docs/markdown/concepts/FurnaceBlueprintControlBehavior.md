...
**Definition:** table{circuit_condition, circuit_enabled, connect_to_logistic_network, include_in_crafting, input_networks, logistic_condition, output_networks, read_contents, read_fuel, read_ingredients, read_recipe_finished, read_working, recipe_finished_signal, working_signal}
