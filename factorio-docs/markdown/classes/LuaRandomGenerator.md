...
Note this is entirely different from calling [math.random](../auxiliary/libraries.md)() and you should be sure you actually want to use this over calling `math.random()`. If you aren't sure if you need to use this over calling `math.random()` then you probably don't need to use this.
...
| Method | Summary |
| --- | --- |
| [re_seed](#re-seed) | Re-seeds the random generator with the given value. |
