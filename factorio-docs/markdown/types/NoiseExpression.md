...
Identifiers are used to name functions and variables. The built-in functions and variables are documented in the [auxiliary docs](../auxiliary/noise-expressions.md). Mods can define their own noise expressions which can be used as variables and functions. The entry points for this are [NamedNoiseFunction](../prototypes/NamedNoiseFunction.md) and [NamedNoiseExpression](../prototypes/NamedNoiseExpression.md) as well as local functions and expressions.
...
**Definition:** [string](../types/string.md) ∣ [boolean](../types/boolean.md) ∣ [double](../types/double.md)
